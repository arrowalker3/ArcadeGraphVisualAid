...
Left Mouse Button:
        Single click - Reposition the main ship to the cursor's grid position
        Double click - Change the main ship's velocity based on the cursor's grid position
    ...
    def draw(self, detailed):
        ...
        # Draw a circle representing the point
            ...
            arcade.draw_circle_filled(self.center.actualX(), self.center.actualY(),
                                      20, arcade.color.RED)
        self.drawInformation(detailed)
        
    def drawDetailed(self):
        alpha = 255
        ...
        if self.functionalPath:
            ...
            arcade.draw_rectangle_filled(x, y, 30, 100, arcade.color.RED, -angle)
        
        
    def drawInformation(self, detailed):
        """
